# Description: Creates a datacenter in vCenter using config
...
lib.e2e_create_datacenter_in_vcenter(vcenter_session_id, config.VCSA().fqdn, config.VCSA().datacenter)
