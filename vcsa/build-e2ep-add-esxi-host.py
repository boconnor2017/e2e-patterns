# Description: Adds an ESXi host to vCenter
...
result = lib.add_host_to_vcenter(session_id, config.VCSA().fqdn, sys.argv[1], config.UNIVERSAL().password, config.ESXI().username, vc_folder)
