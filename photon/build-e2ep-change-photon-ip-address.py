# Description: Changes the IP Address of a virtual machine using PowerCLI container
...
[2] = new ip
[3] = new subnet
[4] = new default gateway
'''
lib.docker_powercli_change_vm_ip_address(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
