# Description: Builds Pattern Node Controller using ovftool, powercli, and paramiko
...
# Build Pattern Node Controller
lib.e2e_build_node_controller(sys.argv[1], logfile_name)
