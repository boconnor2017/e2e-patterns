# Description: Run sh script on remote Photon VM using Paramiko
...
[2] = username
[3] = password
[4] = entrypoint where the sh file is located 
[5] = sh script that you want to run
'''
lib.paramiko_run_sh_on_remote_photon_vm(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5])
