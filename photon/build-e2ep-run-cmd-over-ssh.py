# Description: Run command to remote Photon VM using Paramiko
...
# Run Command to remote Photon VM
'''
[1] = command
[2] = ip address of the remote host
[3] = username of the remote host
[4] = password of the remote host
'''
lib.paramiko_send_command_over_ssh(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
