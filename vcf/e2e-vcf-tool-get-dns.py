...
print("    ESXi Host 01: "+vcf_json["hostSpecs"][0]["hostname"]+" "+vcf_json["hostSpecs"][0]["ipAddressPrivate"]["ipAddress"])
print("    ESXi Host 02: "+vcf_json["hostSpecs"][1]["hostname"]+" "+vcf_json["hostSpecs"][1]["ipAddressPrivate"]["ipAddress"])
print("    ESXi Host 03: "+vcf_json["hostSpecs"][2]["hostname"]+" "+vcf_json["hostSpecs"][2]["ipAddressPrivate"]["ipAddress"])
print("    ESXi Host 04: "+vcf_json["hostSpecs"][3]["hostname"]+" "+vcf_json["hostSpecs"][3]["ipAddressPrivate"]["ipAddress"])
