# Description: Changes the Password on the Tanium Server using Config Parameters
...
lib.write_to_logs(err, logfile_name)
api_response = lib.tanium_change_password(tanium_token, config.UNIVERSAL().password)
